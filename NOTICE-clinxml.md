ClinXML™ — Proprietary Software
© 2026 CLINXML LTD (trading as ClinXML™). All rights reserved.

This software is proprietary and confidential.  
Unauthorised copying, modification, distribution, or commercial use of this
...
SNOMED CT®, was originally created by The College of American Pathologists. "SNOMED" and "SNOMED CT"
...
This applies to the NHS reference data obtained from NHS TRUD — the SNOMED CT UK Primary Care
refsets and the SNOMED CT UK Drug Extension. It does not extend to the SNOMED CT terminology
itself, which is licensed separately as set out above, nor to EMIS-derived content.
