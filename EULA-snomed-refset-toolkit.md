...
Software for personal or internal organisational purposes only.
...
## 3. Ownership
The Software is proprietary. All rights, title, and interest remain with the
author of ClinXML™.

## 4. Disclaimer
The Software is provided "as is" without warranties of any kind. The author is
not liable for any damages arising from use of the Software. Clinical data
displayed by the Software is sourced from NHS Digital and EMIS Health publications
and is provided for reference purposes only. It must not be used as the sole basis
